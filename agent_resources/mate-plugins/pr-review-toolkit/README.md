...
Simply ask questions that match an agent's focus area, and Mate will automatically trigger the appropriate agent:
...
Mate may proactively use these agents based on context:
...
- User agents: `~/.mate/agents/`
- Project agents: `.mate/agents/` in mate-cli-internal
