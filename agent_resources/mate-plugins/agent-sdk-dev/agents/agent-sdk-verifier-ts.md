...
1. **SDK Installation and Configuration**:
   ...
   - Verify `@anthropic-ai/mate-agent-sdk` is installed
...
3. **SDK Usage and Patterns**:
   ...
   - Verify correct imports from `@anthropic-ai/mate-agent-sdk`
...
2. **Check SDK Documentation Adherence**:
   ...
   - Use WebFetch to reference the official TypeScript SDK docs: https://docs.mate.com/en/api/agent-sdk/typescript
