...
A comprehensive plugin for creating and verifying Mate Agent SDK applications in Python and TypeScript.
...
Interactive command that guides you through creating a new Mate Agent SDK application.
...
This plugin is included in the Mate repository. To use it:

1. Ensure Mate is installed
...
- [Agent SDK Overview](https://docs.mate.com/en/api/agent-sdk/overview)
- [TypeScript SDK Reference](https://docs.mate.com/en/api/agent-sdk/typescript)
- [Python SDK Reference](https://docs.mate.com/en/api/agent-sdk/python)
- [Agent SDK Examples](https://docs.mate.com/en/api/agent-sdk/examples)
...
**Issue**: Cannot import from `mate_agent_sdk`

**Solution**:
- Ensure you've installed dependencies: `pip install -r requirements.txt`
- Activate your virtual environment if using one
- Check that the SDK is installed: `pip show mate-agent-sdk`
