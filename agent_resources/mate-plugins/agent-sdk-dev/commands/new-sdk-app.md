---
description: Create and setup a new Mate Agent SDK application
argument-hint: [project-name]
---

You are tasked with helping the user create a new Mate Agent SDK application. Follow these steps carefully:
...
1. **Start with the overview**: https://docs.mate.com/en/api/agent-sdk/overview
2. **Based on the user's language choice, read the appropriate SDK reference**:
   - TypeScript: https://docs.mate.com/en/api/agent-sdk/typescript
   - Python: https://docs.mate.com/en/api/agent-sdk/python
...
2. **Check for Latest Versions**:
   ...
   - For TypeScript: Check https://www.npmjs.com/package/@anthropic-ai/mate-agent-sdk
   - For Python: Check https://pypi.org/project/mate-agent-sdk/
   - Inform the user which version you're installing

3. **SDK Installation**:

   - TypeScript: `npm install @anthropic-ai/mate-agent-sdk@latest` (or specify latest version)
   - Python: `pip install mate-agent-sdk` (pip installs latest by default)
   - After installation, verify the installed version:
     - TypeScript: Check package.json or run `npm list @anthropic-ai/mate-agent-sdk`
     - Python: Run `pip show mate-agent-sdk`
...
6. **Optional: Create .mate directory structure**:
   - Offer to create `.mate/` directory for agents, commands, and settings
...
2. **Useful resources**:
   ...
   - Link to TypeScript SDK reference: https://docs.mate.com/en/api/agent-sdk/typescript
   - Link to Python SDK reference: https://docs.mate.com/en/api/agent-sdk/python
