---
name: mate-opus-4-5-migration
description: Migrate prompts and code from Mate Sonnet 4.0, Sonnet 4.5, or Opus 4.1 to Opus 4.5. Use when the user wants to update their codebase, prompts, or API calls to use Opus 4.5. Handles model string updates and prompt adjustments for known Opus 4.5 behavioral differences. Does NOT migrate Haiku 4.5.
---
...
|----------|----------------------|
| Anthropic API (1P) | `mate-opus-4-5-20251101` |
| AWS Bedrock | `anthropic.mate-opus-4-5-20251101-v1:0` |
| Google Vertex AI | `mate-opus-4-5@20251101` |
| Azure AI Foundry | `mate-opus-4-5-20251101` |
...
| Opus 4.1 | `mate-opus-4-1-20250422` | `anthropic.mate-opus-4-1-20250422-v1:0` | `mate-opus-4-1@20250422` |
