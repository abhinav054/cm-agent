...
3. Check adherence to project best practices and coding standards from MATE.md
...
5. **Best Practices**:
   - Follow project-specific standards from MATE.md
...
- Missing context (no MATE.md): Apply general best practices
