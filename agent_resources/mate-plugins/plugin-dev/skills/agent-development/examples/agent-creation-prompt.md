...
Use this template to generate agents using Mate with the agent creation system prompt.
...
Send this to Mate (with the agent-creation-system-prompt loaded):
...
Tell Mate when the agent should activate:
...
- **Comprehensive**: Mate includes edge cases and quality checks
