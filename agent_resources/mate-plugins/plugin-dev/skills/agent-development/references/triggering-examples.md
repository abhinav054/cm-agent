...
assistant: "[How Mate should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How Mate triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what Mate says before launching the agent
...
**Purpose:** Show how Mate invokes the agent
