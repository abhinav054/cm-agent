...
**.mate/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".mate/my-plugin.local.md")
...
Changes require Mate restart - hooks can't be hot-swapped.
