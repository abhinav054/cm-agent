...
This command helps users create a `.mate/my-plugin.local.md` settings file.
...
Use Write tool to create `.mate/my-plugin.local.md`:
...
To modify settings, edit this file and restart Mate.
```

### Step 4: Inform User

Tell the user:
- Settings file created at `.mate/my-plugin.local.md`
- Current configuration summary
- How to edit manually if needed
- Reminder: Restart Mate for changes to take effect
