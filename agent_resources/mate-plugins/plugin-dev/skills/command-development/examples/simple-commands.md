...
**Important:** All examples below are written as instructions FOR Mate (agent consumption), not messages TO users. Commands tell Mate what to do, not tell users what will happen.

## Example 1: Code Review Command

**File:** `.mate/commands/review.md`
...
**File:** `.mate/commands/security-review.md`
...
**File:** `.mate/commands/test-file.md`
...
**File:** `.mate/commands/document.md`
...
**File:** `.mate/commands/git-status.md`
...
**File:** `.mate/commands/compare-files.md`
...
**File:** `.mate/commands/quick-fix.md`
...
**File:** `.mate/commands/research.md`
