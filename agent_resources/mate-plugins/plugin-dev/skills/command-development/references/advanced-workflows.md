...
Deployment state saved to `.mate/deployment-state.local.md`:
...
Reading deployment state from `.mate/deployment-state.local.md`...
...
```markdown
.mate/plugin-name-workflow.local.md:
...
Reading workflow state from .mate/plugin-name-workflow.local.md...

Current stage: @.mate/plugin-name-workflow.local.md
...
State file: @.mate/plugin-name-workflow.local.md
...
Creating: .mate/feature-complete.flag
...
if [ -f .mate/feature-complete.flag ]; then
...
if [ -f .mate/deployment.lock ]; then
...
!`validate.sh`
echo "checkpoint:validation" >> .mate/deployment-checkpoints.log

## Checkpoint 2: Build
!`build.sh`
echo "checkpoint:build" >> .mate/deployment-checkpoints.log

## Checkpoint 3: Deploy
!`deploy.sh`
echo "checkpoint:deploy" >> .mate/deployment-checkpoints.log
...
Written to .mate/deployment-state.local.md
...
Reading state: @.mate/deployment-state.local.md
...
rm .mate/deployment-state.local.md
