...
# Set up environment
export MATE_PROJECT_DIR="${MATE_PROJECT_DIR:-/tmp/test-project}"
export MATE_PLUGIN_ROOT="${MATE_PLUGIN_ROOT:-$(pwd)}"
export MATE_ENV_FILE="${MATE_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  MATE_PROJECT_DIR=$MATE_PROJECT_DIR"
  echo "  MATE_PLUGIN_ROOT=$MATE_PLUGIN_ROOT"
  echo "  MATE_ENV_FILE=$MATE_ENV_FILE"
  echo ""
fi
