...
Tests individual hook scripts with sample input before deploying to Mate.
...
**Features:**
- Sets up proper environment variables (MATE_PROJECT_DIR, MATE_PLUGIN_ROOT)
...
- Path in hooks.json is correct (use `${MATE_PLUGIN_ROOT}`)
