...
Comprehensive guidance on Mate plugin architecture, directory layout, and best practices.
...
- Portable path references with `${MATE_PLUGIN_ROOT}`
...
- Ask about "${MATE_PLUGIN_ROOT}" usage
...
Mate loads references and examples only as needed based on the task.
