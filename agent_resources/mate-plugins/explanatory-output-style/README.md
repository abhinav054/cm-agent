...
session that encourage Mate to:
...
session. This context instructs Mate to provide brief educational explanations
...
MATE.md, but it is more flexible and allows for distribution through plugins.

Note: Output styles that involve tasks besides software development, are better
expressed as
[subagents](https://docs.mate.com/en/docs/mate/sub-agents), not as
...
- Update the plugin - create a local copy of this plugin to personalize this
  plugin
  - Hint: Ask Mate to read
    https://docs.mate.com/en/docs/mate/plugins.md and set it up for
    you!
