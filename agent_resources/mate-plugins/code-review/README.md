...
2. Gathers relevant MATE.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for MATE.md compliance
...
- MATE.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (MATE.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/MATE.md says "Use camelCase for functions")
...
- General quality issues (unless in MATE.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the Mate repository. The command is automatically available when using Mate.

## Best Practices

### Using `/code-review`
- Maintain clear MATE.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update MATE.md based on recurring review patterns
...
- MATE.md files (optional but recommended for guideline checking)
...
- Make MATE.md more specific about what matters
...
- **Write specific MATE.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update MATE.md based on patterns
...
### Agent architecture
- **2x MATE.md compliance agents**: Redundancy for guideline checks
...
- For MATE.md issues: verifies guideline explicitly mentions it
