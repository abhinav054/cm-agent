...
**Status**: ✅ Active
**File**: .mate/hookify.dangerous-rm.local.md
```
...
2. Or manually create `.mate/hookify.my-rule.local.md` files
...
Check `${MATE_PLUGIN_ROOT}/examples/` for example rule files.
```
