...
# Feeds Mate's output back as input to continue the loop
...
if [[ ! -f "$TRANSCRIPT_PATH" ]]; then
  ...
  echo "   This is unusual and may indicate a Mate internal issue." >&2
...
# The "reason" field contains the prompt that will be sent back to Mate
jq -n \
