...
- Includes Mate attribution in commit message
...
This plugin is included in the Mate repository. The commands are automatically available when using Mate.

## Best Practices

### Using `/commit`
- Review the staged changes before committing
- Let Mate analyze your changes and match your repo's commit style
...
- Mate will analyze the full branch history for the PR description
...
- **Let Mate draft messages**: The commit message analysis learns from your repo's style
